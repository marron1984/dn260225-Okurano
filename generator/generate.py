...
def generate_title(image_path, store_name, course_name, price, lang, output_path):
...
def generate_clip(image_path, category, description, lang, output_path, is_summary=False):
...
def generate_ending(image_path, store_data, lang, output_path):
...
def generate_course(menu, course_id, lang, base_dir):
    ...
    if not generate_title(title_image, store_name, course_name, price, lang, title_path):
        return False
    ...
    for i, dish in enumerate(course["dishes"]):
        ...
        if not generate_clip(image, category, description, lang, clip_path, is_summary):
            return False
    ...
    if not generate_ending(ending_image, store, lang, ending_path):
        return False
